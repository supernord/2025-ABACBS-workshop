...
questions:
objectives:
- Learn how to get functional understanding of uncharacterised protein from structure.
keypoints:
- protein structures are often more conserved than sequences and can be used to infer function.
- Structures provide important clues about function.
---

The goal of this workshop is to explore how predicted protein structures can unlock functional insights.
...
We’ll use this as a representative example of an uncharacterised gene and explore how structure-based annotation can yield new functional hypotheses. 
